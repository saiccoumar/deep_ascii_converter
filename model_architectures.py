...
#         # Encoder
#         self.encoder = nn.Sequential(
#             nn.Conv2d(1, 8, kernel_size=3, stride=1, padding=1),  # Output: (8, 64, 64) [80 parameters]
#             nn.BatchNorm2d(8),                                     # Output: (8, 64, 64) [16 parameters]
#             nn.ReLU(),
#             nn.Conv2d(8, 32, kernel_size=3, stride=1, padding=1),  # Output: (32, 64, 64) [584 parameters]
#             nn.BatchNorm2d(32),                                    # Output: (32, 64, 64) [16 parameters]
#             nn.ReLU(),
#             nn.Conv2d(32, 64, kernel_size=3, stride=1, padding=1), # Output: (64, 64, 64) [584 parameters]
#             nn.BatchNorm2d(64),                                    # Output: (64, 64, 64) [16 parameters]
#             nn.ReLU(),
#             nn.Conv2d(64, 128, kernel_size=3, stride=1, padding=1),# Output: (128, 64, 64) [584 parameters]
#             nn.BatchNorm2d(128),                                   # Output: (128, 64, 64) [16 parameters]
#             nn.ReLU(),
#             nn.MaxPool2d(2, 2),                                    # Output: (128, 32, 32)
#             nn.Flatten(),                                          # Output: (128 * 32 * 32 = 131072)
#             nn.Linear(128 * 32 * 32, 512),                         # Output: (512) [16,512 parameters]
#             nn.ReLU(),
#             nn.Linear(512, 256),                                   # Output: (256) [8,320 parameters]
#             nn.ReLU(),
#             nn.Linear(256, 192),                                   # Output: (192) [264,192 parameters]
#             nn.ReLU(),
#             nn.Linear(192, 128),                                   # Output: (128) [8,256 parameters]
#             nn.ReLU(),
#             nn.Linear(128, 64),                                    # Output: (64) [8,320 parameters]
#         )
        
#         # Decoder
#         self.decoder = nn.Sequential(
#             nn.Linear(64, 128),                                   # Output: (128) [8,320 parameters]
#             nn.ReLU(),
#             nn.Linear(128, 512),                                  # Output: (512) [16,512 parameters]
#             nn.ReLU(),
#             nn.Linear(512, 1024),                                 # Output: (1024) [8,208 parameters]
#             nn.ReLU(),
#             nn.BatchNorm2d(32),                                    # Output: (32) [32 parameters]
#             nn.ConvTranspose2d(8, 16, kernel_size=3, stride=2, padding=1, output_padding=1), # Output: (16, 16, 16) [2056 parameters]
#             nn.BatchNorm2d(16),                                    # Output: (16, 16, 16) [16 parameters]
#             nn.ReLU(),
#             nn.ConvTranspose2d(16, 32, kernel_size=3, stride=2, padding=1, output_padding=1),# Output: (32, 32, 32) [129 parameters]
#             nn.ReLU(),
#             nn.ConvTranspose2d(32, 64, kernel_size=3, stride=2, padding=1, output_padding=1),# Output: (64, 64, 64) [2056 parameters]
#             nn.ReLU(),
#             nn.ConvTranspose2d(64, 1, kernel_size=3, stride=1, padding=1),                    # Output: (1, 64, 64) [129 parameters]
#             nn.Sigmoid()  # Output: (1, 64, 64)
#         )
